...
//        dumpLifeCycle("onViewStateRestored");
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        Log.i("Mactty", mFragment.getClass().getSimpleName() + " -> setUserVisibleHint isVisibleToUser: " + isVisibleToUser + " =============");
    }
    ...
    public void onHiddenChanged(boolean hidden) {
        Log.i("Mactty", mFragment.getClass().getSimpleName() + " -> onHiddenChanged hidden: " + hidden + " ***************");
    }
...
//        dumpLifeCycle("onConfigurationChanged");
    ...
    public void dumpLifeCycle(final String method) {
        Log.i("Mactty", "name: " + mFragment.getClass().getSimpleName() + " -> " + method);
    }
}